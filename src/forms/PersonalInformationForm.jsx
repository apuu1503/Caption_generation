...
function PersonalInformationForm({ formData, handleChange }) {
    ...
    return (
        <form
            style={{ backgroundColor: '#ffe3ea', margin: '50px', padding: '30px', border: "1px solid black" }}
        >
            <div className="space-y-12 ml-[20%] mr-[20%]">
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-bold leading-7 text-gray-1000 ml-[30%]">Personal Information</h2>
                        ...
                        <div className="text-center" >
                            ...
                            <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                ...
                                >
                                    ...
                                    <input id="file-upload" name="file-upload" type="file" className="sr-only" value={formData.image}
                                        onChange={handleChange} />
                                </label>
